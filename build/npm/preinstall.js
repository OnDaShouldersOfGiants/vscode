...
if (majorNodeVersion < 14 || (majorNodeVersion === 14 && minorNodeVersion < 18) || (majorNodeVersion === 14 && minorNodeVersion === 18 && patchNodeVersion < 4) || majorNodeVersion >= 18) {
	console.error('\033[1;31m*** Please use node.js versions >=14.17.4 and <18.\033[0;0m');
	err = true;
}
